...
public class AllResturantsAdapter extends RecyclerView.Adapter<AllResturantsAdapter.ViewHolder> {
    List<Allresturentmodels>list;
    public AllResturantsAdapter(List<Allresturentmodels>list){
        this.list=list;
    }
